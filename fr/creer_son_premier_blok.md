...
lire le tutoriel sur les paquets python pour le pypi http://sametmax.com/creer-un-setup-py-et-mettre-sa-bibliotheque-python-en-ligne-sur-pypi/
...
Le fichier setup doit définir l'entry_point bloks. Celui ci pointe vers une module python, Ce module porte la déclaration du blok.
...
Les methodes sont disponibles via l'interpreter.
...
Modifier le fichier
> anyblok_todolist/anyblok_todolist/todolist/tests/test_todo.py
